    ...
    <>
      <Dashboard.Container>
        <Dashboard.Navigation>
          ...
          {
            adminRole === 'Developer' || adminRole === 'Admin' ? 
            <Dashboard.NavigationButton onClick={() => setVisibleComponent('AddData')}>
              Add To DB
          ...
          {
            adminRole === 'Developer' || adminRole === 'Admin' ? 
            <Dashboard.NavigationButton onClick={() => setVisibleComponent('ManageHOD')}>
              Manage HODs
            </Dashboard.NavigationButton> : null
          }
          ...
          {
            adminRole === 'Developer' ? 
            <Dashboard.NavigationButton onClick={() => setVisibleComponent('ManageAdmins')}>
              Manage Admins
            </Dashboard.NavigationButton> : null
          }

          {
            adminRole === 'Admin' || adminRole === 'Developer' ? 
